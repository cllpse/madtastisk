<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Madtastisk.Master" Inherits="System.Web.Mvc.ViewPage<Iteration2.Models.RecipeDTO>" %>
...
<asp:Content runat="server" ContentPlaceHolderID="cphBody">
    <% Html.RenderPartial("~/Views/Shared/Header.ascx", new Iteration2.Models.HeaderConfiguration { SelectedMenuItem = Iteration2.Models.HeaderConfiguration.MenuItem.None }); %>
