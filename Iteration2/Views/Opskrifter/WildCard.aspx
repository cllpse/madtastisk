...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cphBody">
    ...
    <div id="searchrecipe">
        <% using (Html.BeginForm()) { %>
            <div id="tabs">
                <ul>
		            <li><a href="#tabs-0" id="t0" title="Søg efter opskrifter udfra hvilke ingredienser du har til rådighed">Ingredienser</a></li>
		            <li><a href="#tabs-1" id="t1" title="Søg efter opskrifter udfra navn">Opskrifter</a></li>
	            </ul>
