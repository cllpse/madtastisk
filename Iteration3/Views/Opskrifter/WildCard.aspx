        ...
        <% using (Html.BeginForm()) { %>
            <div id="tabs">
                <ul>
		            ...
		            <li><a href="#tabs-0" id="t0" title="Søg efter opskrifter udfra navn">Navn</a></li>
                    <li><a href="#tabs-1" id="t1" title="Søg efter opskrifter udfra hvilke ingredienser du har til rådighed">Ingredienser</a></li>
	            </ul>
                ...
                <div id="tabs-1">
                    <div class="info">
                        ...
                        <p>
                            Søg på opskrifter udfra ingredienser du har til rådighed. For eksempel <strong>"4 stk tomat, 200 g ost, mel, vand"</strong><br />
