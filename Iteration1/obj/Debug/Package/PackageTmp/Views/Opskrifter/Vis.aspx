<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Madtastisk.Master" Inherits="System.Web.Mvc.ViewPage<Iteration1.Models.RecipeDTO>" %>
...
<asp:Content runat="server" ContentPlaceHolderID="cphBody">
    <% Html.RenderPartial("~/Views/Shared/Header.ascx", new Iteration1.Models.HeaderConfiguration { SelectedMenuItem = Iteration1.Models.HeaderConfiguration.MenuItem.None }); %>
