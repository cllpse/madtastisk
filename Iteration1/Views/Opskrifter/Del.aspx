...
<asp:Content runat="server" ContentPlaceHolderID="cphHead">
    ...
    <script type="text/javascript">
        ...
        //var input = $("<input />", { type: "text", id: i, name: i, value: "value #" + i });

    </script>
</asp:Content>

<asp:Content runat="server" ContentPlaceHolderID="cphBody">
    <% Html.RenderPartial("~/Views/Shared/Header.ascx", new Iteration1.Models.HeaderConfiguration { SelectedMenuItem = Iteration1.Models.HeaderConfiguration.MenuItem.AddRecipe }); %>
